...
Original file is located at
    https://colab.research.google.com/drive/1DM7vGDw7NUsPXafvLg10qxYqLqycOtgL
"""
...
demo = gr.Interface(
    ...
    outputs=[
        ...
        gr.Markdown(label="Suggestion & Best Fit Role")
    ],
    title="Resume Analyzer based on JD",
    description="Upload Your Resume & JD to get ATS match Score",
    theme="default"
)
